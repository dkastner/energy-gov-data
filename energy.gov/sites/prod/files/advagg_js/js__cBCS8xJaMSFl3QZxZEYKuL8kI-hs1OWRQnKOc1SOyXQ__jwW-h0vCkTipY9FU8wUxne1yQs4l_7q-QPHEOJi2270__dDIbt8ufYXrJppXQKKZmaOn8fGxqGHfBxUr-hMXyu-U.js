...
(function($) {
    $(document).ready(function() {
      var items = $('.field-type-energy-hero-multiple'),
        thumbs = $('.energy-hero-thumbnails');
      thumbs.find('img').each(function(i) {
        $(this).click(function(e) {
          e.preventDefault();
          thumbs.find('.field-item-thumb').removeClass('active');
          $(this).closest('.field-item-thumb').addClass('active');
          items.find('.field-item').removeClass('active').filter('.field-item-' + i).addClass('active');
        });
      });
    });
})(jQuery);;/**/
